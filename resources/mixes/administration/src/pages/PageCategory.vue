    ...
    export default {
        ...
        data() {
            return {
                ...
                form: {
                    ...
                    seo_keyword: '',
                    seo_description: '',
                    title: injection.trans('content.page.category.modal.create'),
                    top_image: '',
                },
                loading: false,
                modal: {
                    ...
                    alias: [
                        {
                            required: true,
                            type: 'string',
                            message: injection.trans('content.page.category.form.alias.error'),
                            trigger: 'change',
                        },
                    ],
                    name: [
                        {
                            required: true,
                            type: 'string',
                            message: injection.trans('content.page.category.form.name.error'),
                            trigger: 'change',
                        },
                    ],
                },
        ...
        methods: {
            create() {
                ...
                self.form.title = injection.trans('content.page.category.modal.create');
                self.form.top_image = '';
            ...
            edit(item) {
                ...
                self.form.title = injection.trans('content.page.category.modal.edit');
                ...
                if (self.form.pattern === 'create') {
                    self.$refs.form.validate(valid => {
                        if (valid) {
                            ...
                            self.$notice.error({
                                title: injection.trans('content.page.category.info.error'),
                            });
                            self.modal.loading = false;
                            self.modal.visible = false;
                        }
    ...
    <div class="article-wrap">
        <div class="article-list">
            <card :bordered="false">
                <template slot="title">
                    <div class="filter">
                        <i-button type="primary" @click.native="create">{{ trans('content.page.category.info.add') }}</i-button>
                    </div>
                </template>
                <div class="none-item" v-if="list.length === 0">{{ trans('content.page.category.info.none') }}</div>
        ...
        <modal :loading="modal.loading" :value="modal.visible" @on-cancel="modal.visible = false" @on-ok="submit">
            ...
            <i-form label-position="left" :model="form" ref="form" :rules="rules">
                <form-item :label="trans('content.page.category.form.name.label')" prop="name">
                    <i-input :placeholder="trans('content.page.category.form.name.placeholder')" v-model="form.name"></i-input>
                </form-item>
                <form-item :label="trans('content.page.category.form.alias.label')" prop="alias">
                    <i-input :placeholder="trans('content.page.category.form.alias.placeholder')" v-model="form.alias"></i-input>
                </form-item>
                <form-item :label="trans('content.page.category.form.link.label')" prop="link">
                    <i-input :placeholder="trans('content.page.category.form.link.placeholder')" v-model="form.link"></i-input>
                </form-item>
                <form-item :label="trans('content.page.category.form.description.label')" prop="description">
                    <i-input :placeholder="trans('content.page.category.form.description.placeholder')" v-model="form.description"></i-input>
                </form-item>
                <form-item :label="trans('content.page.category.form.background.label')" prop="background">
                    <i-input :placeholder="trans('content.page.category.form.background.placeholder')" v-model="form.background_color"></i-input>
                </form-item>
            </i-form>
        </modal>
    </div>
